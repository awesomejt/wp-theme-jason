<?php
/**
 * Jason Theme functions and definitions
 *
 * @package Jason Theme
 */
...
function jason_setup() {
	 ...
	 * If you're building a theme based on Jason Theme, use a find and replace
	...
	add_theme_support( 'custom-background', apply_filters( 'jason_custom_background_args', array(
...
function jason_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'jason_content_width', 640 );
}
...
function jason_scripts() {
	...
	wp_enqueue_script( 'jason-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'jason-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
